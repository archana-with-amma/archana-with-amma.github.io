...
// Generated by CoffeeScript 1.10.0
app.service("VerseHandler", function(LocalVerseData, VerseLocalStorage, $q, $timeout) {
  var audioDefered;
  audioDefered = void 0;
  this.reload = function() {
    this.nextVerseTimeout = true;
    this.resetNextVerseTimeout = function() {
      this.nextVerseTimeout = false;
      return $timeout((function(_this) {
        return function() {
          return _this.nextVerseTimeout = true;
        };
      })(this), 1000);
    };
  ...
  this.next = function() {
    if (this.nextVerseTimeout && this.hasNext()) {
      this.resetNextVerseTimeout();
...
app.controller("LearnCtrl", function($scope, VerseHandler, VerseLocalStorage, mobile, hotkeys, History, $location, $rootScope) {
  ...
  $scope.fixSlider = function() {
    setTimeout(function() {
      return $rootScope.$broadcast("rzSliderForceRender");
    }, 200);
    return true;
  };
